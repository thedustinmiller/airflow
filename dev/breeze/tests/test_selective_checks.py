        ...
        (
            pytest.param(
                ...
                "main",
                {
                    ...
                    "kubernetes-combos-list-as-string": "3.8-v1.28.13 3.9-v1.29.8 3.10-v1.30.4 3.11-v1.31.0 3.12-v1.28.13",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
                    "docs-build": "true",
        ...
        (
            pytest.param(
                ...
                "main",
                {
                    ...
                    "kubernetes-combos-list-as-string": "3.8-v1.28.13",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
                    "docs-build": "true",
    ...
    [
        pytest.param(
            ("INTHEWILD.md",),
            {
                ...
                "mypy-airflow,mypy-dev,mypy-docs,mypy-providers,ts-compile-format-lint-www",
                "skip-provider-tests": "true",
                "parallel-test-types-list-as-string": None,
                "needs-mypy": "false",
                "mypy-folders": "[]",
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            (),
            dict(),
            '["self-hosted", "airflow-runner", "eks-runner", "X64", "small"]',
            '["self-hosted", "airflow-runner", "eks-runner", "X64", "small"]',
            "true",
            "true",
            "true",
